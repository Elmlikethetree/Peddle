...
},  
{
  ...
  date: "2026-08-14",
  hints: [
    "A 2 year old boy presents with abnormal posturing on his right side when walking.",
    "On exam he has increased tone and abnormal flexion in his right limbs with low tone in his trunk and neck.",
    "He was born term and had a prolonged NICU stay for neonatal stroke.",
    "The diagnosis is made clinically. Early intervention is essential and he is seen by a multidisciplinary team including PT, OT, and SLP.",
    "He is later diagnosed with epilepsy, ID, speech and language impairment, feeding difficulties, chronic pain, and vision problems."
  ],
  answer: "Spastic hemiplegia cerebral palsy (CP)",
  accepted: ["CP"],
  explanation: "CP refers to a heterogeneous group of non-progressive neurodevelopmental conditions characterized by impairments in motor function that limit activity and are caused by a disturbance to the developing fetal or infant brain. CP can be classified by limb distribution, hypertonia or movement disorder type, or function using the GMFCS levels. In this case, spastic hemiplegia affects one side of the body. Care is centered around the 6 F's - function, family, fitness, fun, friends, and future."
},
  {
  id: "Question 36",
  date: "2026-08-15",
  hints: [
    "3 day old newborn female born at 37 weeks gestation presents with yellowing of their skin.",
    "Mother and baby are both A+ and DAT negative. No family history of G6PD. 24 hour serum bilirubin was normal.",
    "There are no feeding difficulties or lethargy and she had 4 wet diapers with normal stools over the last 24 hours.",
    "On exam she has scleral icterus and mild jaundice of the face and torso. Exam is otherwise normal.",
    "Bloodwork reports unconjugated hyperbilirubinemia above the treatment threshold and she is admitted for phototherapy.",
  ],
  answer: "Benign neonatal hyperbilirubinemia",
  accepted: ["Physiologic jaundice"],
  explanation: "Unconjugated hyperbilirubinemia in the neonate is a normal transitional phenomenon caused by the turnover of fetal red blood cells, the immaturity of the newborn's liver to efficiently conjugate bilirubin, and increased enterohepatic circulation. Total serum bilirubin levels peak at 48 to 96 hours of age. Management involves adequate nutrition, oral hydration, and phototherapy if needed to prevent severe hyperbilirubinemia and bilirubin-induced neurologic disorders."
},
];
